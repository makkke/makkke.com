    ...
    $('#contact-form').on('submit', function (e) {
        ...
        if (!e.isDefaultPrevented()) {
            var messageAlert = 'alert alert-success';
						var messageText = 'Message sent successfully. Thank you, will get back to you soon!';
	...
	/* ===== GOOGLE MAPS  ===== */
        ...
        var $latitude = 49.283778, //If you unable to find latitude and longitude of your address. Please visit http://www.latlong.net/convert-address-to-lat-long.html you can easily generate.
